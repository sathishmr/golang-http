pipeline {
    ...
    stages {
      stage('CI Build and push snapshot') {
        ...
        steps {
          dir ('/home/jenkins/go/src/https://github.com/sathishmr/golang-http') {
            checkout scm
            container('go') {
              sh "make linux"
          ...
          dir ('/home/jenkins/go/src/https://github.com/sathishmr/golang-http/charts/preview') {
            container('go') {
              sh "make preview"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/https://github.com/sathishmr/golang-http/charts/golang-http') {
